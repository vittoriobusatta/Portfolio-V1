...
const NavbarContainer = styled.section`
  ...
  transition: all 0.3s ease-in, top 0.3s;
...
const BurgerContainer = styled.button`
  ...
  &:hover > .bar1 {
    transform: ${(props) =>
      props.isActive === true
        ? "translate3d(0, 18px, 0) rotate(45deg)"
        : "translate3d(0, 10px, 0) rotate(-180deg)"};
  }
  &:hover > .bar2 {
    transform: ${(props) =>
      props.isActive === true
        ? "translate3d(0, -19px, 0) rotate(495deg)"
        : "translateY(-10px) rotate(-180deg)"};
  }
      ...
      <NavBarWrap>
        <NavBarFlex1>
          <MenuBtnContainer>
            ...
            <TextRotate isLight={lightMode} onClick={ClickMenu}>
              Menu
            </TextRotate>
          </MenuBtnContainer>
        </NavBarFlex1>
        ...
        <NavBarFlex2>
          <HomeBtnContainer>
            <Link to="/">
              <TextRotate isLight={lightMode} onClick={ClickHome}>
                Home
              </TextRotate>
            </Link>
          </HomeBtnContainer>
        ...
        <NavBarFlex3>
          <ContactBtnContainer>
            <Link to="/contact">
              <TextRotate isLight={lightMode} onClick={ClickContact}>
                Contact
              </TextRotate>
            </Link>
            ...
            <SocialsLinks>
              <li style={{ marginBottom: 2 + "rem" }}>
                <LinksIcon
                  isLight={lightMode}
                  href="https://dribbble.com/FlytzWoo"
                >
              ...
              <li>
                <LinksIcon
                  isLight={lightMode}
                  href="https://twitter.com/busvtta"
                >
