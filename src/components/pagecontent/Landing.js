...
import {secondColor, thirdColor, morgenWalsh, roboto, fourthColor, fourthLightColor, secondLightColor, thirdLightColor} from '../Common';
      ...
      <Header>
        <Head>
          <div style={{height: 100 + "%", width: 90 + "%", display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <BigText isLight={lightMode}>Portfolio&nbsp;<Indent isLight={lightMode}/>&nbsp;V1<Arrow />
              <Fleche isLight={lightMode} width="31" height="34" viewBox="0 0 31 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.715 26.0643L23.7142 27.1208L28.0971 22.6086L30.4898 25.2414L23.2138 32.7321C22.5533 33.4137 21.4803 33.3767 20.8193 32.6495L13.5539 24.6571L15.9508 22.1896L20.327 27.004L20.3277 25.9474C20.3363 13.9932 11.2407 3.99715 0.020518 3.6068L0.023101 4.36792e-05C13.114 0.455467 23.725 12.1187 23.715 26.0643Z" fill="#FFEDCB"/>
              </Fleche>
            </BigText>
          </div>
