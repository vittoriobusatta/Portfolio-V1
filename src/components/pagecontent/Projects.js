            ...
            <div style={{height: 'auto', width: 100 + "%"}}>
                <div style={{height: 100 + "%", width: 100 + "%"}}>
                    <OldchildContent>
                        ...
                        <Number isLight={lightMode} className="oldchild2">02</Number>
                    </OldchildContent>
                ...
                <Content>
                    ...
                    <DateProject>
                        <div style={{height: 'auto', width: 100 + "%", display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end'}}>
                            ...
                            <SvgDate isLight={lightMode}  width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M6.579 1.413H0.504V0H9V8.496H7.587V2.43L0.99 9L0 8.001L6.579 1.413Z" fill="#FFEDCB"/>
                            </SvgDate>
                        </div>
                    </DateProject>
                </Content>
